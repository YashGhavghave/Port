...
function Home() {
  return (
    <div id='container1' className='h-[80vh] w-[80vw] relative top-[68rem] bg-gradient-to-r from-red-500 to-blue-500  left-[10vw] rounded-3xl max-md:h-[90vh] max-sm:h-[80vh]  max-2xl:h-[90vh]'>
